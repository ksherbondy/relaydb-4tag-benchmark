 ...
 * Date: 2026-05-22
 * Purpose:
 *   Read a prototype RelayDB columnar binary artifact and benchmark the
 *   precompiled bitset query path.
 *
 *   This avoids rebuilding lanes from JSONL at open time.
 */
...
function main() {
  ...
  console.log("RelayDB Columnar Artifact Reader v0");
  console.log("===================================");
