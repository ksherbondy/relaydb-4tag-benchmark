...
} = require("./raw-people-companies-normalized-graph-v2");
...
async function benchmarkRawNormalizedOnce() {
  ...
  const graph = buildRawPeopleCompaniesNormalizedGraphV2(companies, people);
...
function buildMarkdownReport(report) {
  ...
  lines.push("# People + Companies Normalized Runtime Benchmark V2");
  lines.push("");
